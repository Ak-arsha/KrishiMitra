      ...
      <div className="w-full max-w-lg relative z-10 my-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-300 text-sm mt-1.5 font-medium">
            Multi-Role Platform for Farmers, Buyers, Investors & Traders
          </p>
        </div>
        ...
        <div className="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 p-8">
          <div className="mb-6">
            <h2 className="text-2xl font-bold text-gray-900 tracking-tight">Create Free Account</h2>
            <p className="text-gray-500 text-sm mt-0.5">Select your primary role to access dedicated tools</p>
          </div>

          {/* Account Exists Red Banner Error Display */}
          {error && (
            <div className="mb-6 bg-red-50 border border-red-200 rounded-2xl p-4 flex items-start gap-3 text-red-700 text-sm animate-fade-in shadow-sm">
              ...
              <div>
                ...
                <p className="font-medium text-red-700 mt-0.5">{error}</p>
                {error.includes("already exists") && (
                  <Link href="/login" className="text-xs font-bold text-red-900 underline mt-2 inline-block">
        ...
        <div className="fixed inset-0 z-50 bg-black/70 backdrop-blur-sm flex items-center justify-center p-4 animate-fade-in">
          <div className="bg-white rounded-2xl max-w-md w-full shadow-2xl border border-gray-300 overflow-hidden font-sans border-t-8 border-t-blue-500">
            ...
            <div className="p-6 text-center space-y-2 border-b border-gray-100">
              ...
              <h3 className="text-xl font-bold text-gray-900">Sign up with Google</h3>
